...
class RobotController(Node):
    ...
    def move_forward(self, speed=0.5):
        ...
        self.movement_thread = threading.Thread(
            target=self._continuous_move, args=(speed, "forward")
        )
    ...
    def move_backward(self, speed=0.5):
        ...
        self.is_moving = True
        self.movement_thread = threading.Thread(
            target=self._continuous_move, args=(speed, "backward")
        )
        self.movement_thread.start()
    ...
    def turn_left(self, angular_speed=0.5):
        ...
        self.is_moving = True
        self.movement_thread = threading.Thread(
            target=self._continuous_move, args=(angular_speed, "left")
        )
        self.movement_thread.start()
    ...
    def turn_right(self, angular_speed=0.5):
        ...
        self.is_moving = True
        self.movement_thread = threading.Thread(
            target=self._continuous_move, args=(angular_speed, "right")
        )
        self.movement_thread.start()
