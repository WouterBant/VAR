...
class WheelOdometry:
    ...
    def joint_state_callback(self, msg):
        ...
        return (self.current_x, self.current_y), 180 * abs(
            self.current_theta - math.pi
        )  # math.degrees(radians) transforms radians to degrees
    ...
    #     left_wheel_value = joint_data.get("left_wheel_joint", None) * 0.794/self.WHEEL_CIRCUMFERENCE
    #     right_wheel_value = joint_data.get("right_wheel_joint", None) * 0.794/self.WHEEL_CIRCUMFERENCE
